...
const SmartStoreLogo = ({ className = "w-32 h-auto" }) => {
  return (
    <svg viewBox="0 0 250 40" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      ...
      <text x="170" y="26" fontFamily="Inter, sans-serif" fontWeight="300" fontSize="20" letterSpacing="0.1em" fill="currentColor">STORE</text>
    </svg>
  );
};
